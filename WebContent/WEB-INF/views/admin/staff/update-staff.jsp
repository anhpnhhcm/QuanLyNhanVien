...
<body>
	<div id="row">
		<div class="row">
			<div class="login-bg"
				style="width: 584px; height: 770px; margin-top: 40px; margin-left: 320px;">
				<div class="row">
					<div class="col-lg-12">
				...
				<p>${message}</p>
				<form:form action="admin/staff/updatestaff.htm"
					...
					<button type="submit" class="btn btn-primary"
						style="margin-left: 600px; margin-top: 30px">Lưu</button>
				</form:form>
			</div>
		</div>
	</div>
